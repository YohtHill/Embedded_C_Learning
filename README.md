...
| 项目 | 说明 | 状态 |
|------|------|------|
| BM43112DC02 | 指纹模组（原理图绘制）| ✅ 原理图完成（2026-08-17）|
| BM22192DA06 | 指纹模组 | 📁 已归档 |
| BF83080C_V1.0 | 指纹模组 | 📁 已归档 |
| BM3218+BF83112 | 指纹模组 | 📁 已归档 |
| VB2032-241203 | 指纹模组 | 📁 已归档 |
